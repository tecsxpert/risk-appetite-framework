    ...
    <div className="p-6 rounded-2xl bg-gradient-to-br from-red-50/80 to-orange-50/80 border border-red-200/60 shadow-sm animate-in fade-in slide-in-from-top-4 duration-400">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <button
            onClick={onRetry}
            className="mt-4 inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-red-700 bg-white border border-red-200 rounded-lg shadow-sm hover:bg-red-50 hover:border-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200"
          >
