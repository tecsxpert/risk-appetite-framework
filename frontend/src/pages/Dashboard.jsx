      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex justify-between items-end">
          ...
          <button 
            ...
            className="flex items-center space-x-2 bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100 hover:bg-gray-50 transition font-semibold text-gray-600"
          >
