        ...
        <div className="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <Link
                to={`/risks/${id}/edit`}
                className="inline-flex items-center gap-2 px-4 min-h-[44px] bg-[#1B4F8A] text-white text-sm font-medium rounded-lg hover:bg-[#164a75] transition-colors shadow-sm"
              >
              ...
              <button
                ...
                disabled={deleting}
                className="inline-flex items-center gap-2 px-4 min-h-[44px] border-2 border-red-200 text-red-600 text-sm font-medium rounded-lg hover:bg-red-50 hover:border-red-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
